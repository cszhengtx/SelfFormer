...
def main():
    ...
    args.add_argument('-s', '--session_name', default='test-0',  type=str)
    ...
    args.add_argument(      '--pretrained',   default=r'/home/kemove/ztx/project/SelfFormer/output/trying-0/checkpoint/trying-0_001.pth',  type=str)
